...
export const Question = ({question, questionNumber, onNext}: Props) => {
  ...
  return (
    <div className={styles.question}>
      <span className={styles.question__text}>{`${questionNumber}. ${question.question}`}</span>
      {type === "text" && <TextQuestion value={value} setValue={setValue} />}
      {type === "brief" && <BriefQuestion value={value} setValue={setValue} />}
      {variants && type === "single" && <SingleQuestion variants={variants} value={value} setValue={setValue} />}
      {variants && type === "multiple" && <MultipleQuestion variants={variants} value={value} setValue={setValue} />}
